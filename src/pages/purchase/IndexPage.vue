  ...
  <q-page class="income-expense-page">
    ...
    <div class="summary-section bg-white q-pa-md">
      <div class="row items-center no-wrap">
        <div class="col-auto">
          <span class="text-grey-7 text-body2">{{ filteredTransactions.length }} hoá đơn. Tổng tiền: </span>
        ...
        <q-card-section class="q-pa-md">
          <div class="row items-center no-wrap">
            <div class="col">
              ...
              <div class="transaction-code text-caption text-grey-6 q-mb-xs">
                {{ transaction.code }}
              </div>
              <div class="transaction-code text-caption text-primary">
                <span class="invoide-code">
