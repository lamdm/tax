<template>
  <q-page class="profile-page">
    <div class="page-header">
      <h2 class="text-h4 q-mb-md">Cá nhân</h2>
      <p class="text-body1 q-mb-lg">Quản lý thông tin cá nhân</p>
    </div>
        ...
        <q-list>
          <q-item clickable v-ripple>
            ...
            <q-item-section>
              ...
              <q-item-label caption>Cập nhật thông tin cá nhân</q-item-label>
            </q-item-section>
            <q-item-section side>
          ...
          <q-item clickable v-ripple>
            ...
            <q-item-section>
              ...
              <q-item-label caption>Thay đổi mật khẩu đăng nhập</q-item-label>
            </q-item-section>
            <q-item-section side>
              <q-icon name="chevron_right" />
            </q-item-section>
          ...
          <q-item clickable v-ripple>
            ...
            <q-item-section>
              <q-item-label>Trợ giúp</q-item-label>
              <q-item-label caption>Hướng dẫn sử dụng</q-item-label>
            </q-item-section>
            <q-item-section side>
              <q-icon name="chevron_right" />
            </q-item-section>
